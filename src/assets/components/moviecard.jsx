        ...
        return(
            ...
            <section className="moviecard-container">
                ...
                <div className="moviecard-container__data">
                    ...
                    <button className="moviecard-container__trailerbtn" onClick={handleseetrailer} >Watch trailer</button>
                </div>
                ...
                <article className="moviecard-synopsis">
                    <div>
                        {seetrailer&&<iframe className="moviecard-synopsis__trailer" src={searchmovie.framever} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>}
                    </div>
